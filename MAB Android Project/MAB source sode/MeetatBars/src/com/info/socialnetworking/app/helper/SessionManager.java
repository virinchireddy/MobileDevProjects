...
public class SessionManager {
     ...
     * */
    public void createLoginSession(int userId,int userType){
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(_context, BarHopperLogin.class);
    ...
    public HashMap<String,Integer> getUserDetails(){
        ...
        user.put(USER_TYPE, pref.getInt(USER_TYPE, 0));
    ...
    public void logoutUser(){
        ...
        editor.clear();
        editor.commit();
        if(BarHopperLogin.isLoggedInWithFB())

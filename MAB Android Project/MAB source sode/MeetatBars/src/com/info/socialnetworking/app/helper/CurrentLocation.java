...
public class CurrentLocation extends Service implements LocationListener {
	...
	public static boolean inVisinity=true;
					...
					public void onResponse(JSONObject response) {
						...
						try {
							...
							if (!error) {
								...
								//inVisinity=response.getBoolean("vicinity_status");
								
								//Toast.makeText(mContext.getApplicationContext(), inVisinity+"", Toast.LENGTH_SHORT).show();
	...
	public void onLocationChanged(Location location) {
		...
		updateLocation(MainMenu.user_id);
	}

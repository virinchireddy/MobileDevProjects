...
public class FieldValueSpec implements Serializable {

	private static final long serialVersionUID = 1L;

	@SuppressWarnings("unused")
	private static final String TAG = "FieldValueSpec";
	 ...
	 */
	public static FieldValueSpec parse(JSONObject json,
			Context applicationContext) throws JSONException, ParseException {
		FieldValueSpec valueSpec = new FieldValueSpec();
